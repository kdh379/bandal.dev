export const meta = {
  title: "검색엔진최적화 SEO",
  description: "검색엔진최적화 SEO 방법을 소개합니다.",
  date: "2023-10-22",
};
...
- [Google 검색 센터](https://developers.google.com/search/docs/fundamentals/seo-starter-guide?hl=ko)
- [네이버 서치 어드바이저](https://searchadvisor.naver.com/guide/seo-basic-intro)
